...
const BLUEPRINT_I18N: Record<Language, BlueprintStrings> = {
  th: {
    ...
    cap4Title: 'Model Provider Routing',
    cap4Desc: 'ระบบจัดสรรและสลับผู้ให้บริการโมเดลอัจฉริยะ ป้องกัน Vendor Lock-in และสลับระหว่าง Local On-Premise GPU กับ Cloud AI ได้ทันที',
    cap4Items: [
      'Local Compute Plane: ขับเคลื่อนด้วย Local GPU (Ollama / vLLM / NVIDIA NIM) ประมวลผลภายในองค์กร 100%',
      'Cloud AI Adapters: รองรับการเชื่อมต่อเสริมไปยัง OpenAI, Anthropic Claude, Google Gemini',
      'Dynamic Model Sizing: ส่งงานง่ายให้ Small LLM (เร็ว/ประหยัด) และส่งงานยากให้ Large LLM',
      'Provider Agnostic: เปลี่ยนโมเดลหรืออัปเกรดการ์ดจอใหม่ได้ตลอดเวลาโดยไม่ต้องแก้โค้ดระบบหน้าบ้าน',
    ],
    ...
    featD: {
      ...
      desc: 'ผู้บริหารไม่ต้องเขียน SQL ระบบจะแปลงคำถามภาษาไทย ➔ Intent ➔ SQL Agent ➔ Generate SQL ➔ Validate ป้องกันคำสั่งอันตราย ➔ Read-only DB ➔ ผลลัพธ์สรุปเป็นตารางและกราฟ Insight ทันที',
      example: '💬 "แสดงยอดขาย 10 ลูกค้าที่ซื้อสินค้ามากที่สุดในปีนี้พร้อมคำนวณสัดส่วน %"',
    },
    featE: {
      badge: '6. AGENTIC RAG',
      title: '🔍 Agentic RAG วิเคราะห์หลายมิติข้ามระบบ',
      desc: 'ไม่เพียงแค่ค้นหาข้อมูลแบบเดิม แต่ Agent จะวิเคราะห์คำถามลึกซึ้ง เช่น เมื่อถามว่า "ทำไมยอดผลิตสัปดาห์นี้ลดลง" Agent จะดึงข้อมูล Production + Inventory + Downtime + Reject + Maintenance มารวมวิเคราะห์หาสาเหตุจริง',
    },
    featF: {
      badge: '7. GRAPHRAG',
      title: '🕸️ GraphRAG & Knowledge Graph',
      desc: 'เข้าใจความสัมพันธ์ของข้อมูลแบบร่างแห เช่น Customer ➔ Order ➔ Product ➔ Production ➔ Lot ➔ Machine ➔ Quality ➔ Reject ทำให้ตอบคำถามที่ซับซ้อนเชิงลึกได้แม่นยำ',
    },
    featG: {
      badge: '8. AI AGENTS',
      title: '🤖 Specialized AI Agents เฉพาะสายงาน',
      desc: 'Finance Agent (ยอดขาย, ลูกหนี้, Cash Flow), HR Agent (วันลา, เอกสารสวัสดิการ), Production Agent (WIP, Machine OEE, Reject Rate), Inventory Agent (Stock Movement, Lot Reorder)',
    },
    featH: {
      badge: '9. MCP TOOLS',
      title: '🛠️ Model Context Protocol (MCP) & Tool Sandbox',
      desc: 'AI สามารถเรียกใช้งานเครื่องมือของบริษัท (ERP Tool, Report Tool, Notification Tool) ภายใต้การควบคุมด้าน Permission, Authorization, Audit, Rate Limit และ Scope อย่างเข้มงวด',
    },
    secTitle: '🔒 16. ความปลอดภัยหลายชั้น (Multi-Layer Enterprise Security)',
    secSteps: [
      { num: '1', title: 'User Identity', desc: 'ยืนยันตัวตนผู้ใช้ผ่านระบบองค์กร' },
      { num: '2', title: 'JWT & Scopes', desc: 'ออกสิทธิ์และขอบเขตตามบทบาท' },
      { num: '3', title: 'AI Gateway', desc: 'ตรวจจับและ Redact ข้อมูล PII' },
      { num: '4', title: 'Company Filter', desc: 'กรองสิทธิ์เห็นเฉพาะข้อมูลบริษัทตนเอง' },
      { num: '5', title: 'Read-Only DB', desc: 'เข้าถึงข้อมูลผ่าน Sandbox ปลอดภัย' },
    ],
    secPillars: [
      { title: '🛡️ 17. ความเสถียร (Fault Isolation)', desc: 'สถาปัตยกรรมแยก Control Plane และ Compute Plane ออกจากกันอย่างเด็ดขาด ปัญหา GPU ไม่กระทบระบบ ERP' },
      { title: '🎯 18. ความถูกต้อง (Grounding)', desc: 'ลดปัญหา AI แต่งเรื่อง โดยให้ AI ตอบจากข้อมูลจริงใน ERP/Knowledge Base พร้อมแสดง Source Citations' },
      { title: '⚡ 19. ความรวดเร็ว & Caching', desc: 'รองรับ Streaming Tokens, Semantic Caching ด้วย Redis, Model Routing ช่วยกระจายงาน' },
      { title: '💰 20. การควบคุมงบประมาณ', desc: 'กำหนดเพดานโควตา Token Limit รายบุคคล รายแผนก พร้อมแดชบอร์ดตรวจสอบการใช้งานโปร่งใส' },
    ],
    hwTitle: '💻 22. ตารางแนะนำฮาร์ดแวร์ตามจำนวนผู้ใช้งาน (Hardware Sizing Guide)',
    ...
    hwRecs: [
      ...
      { title: '🔀 28. กลยุทธ์ Model Routing', desc: 'Small LLM (3B-8B) สำหรับ Intent/Routing, Medium LLM (14B-32B) สำหรับ Chat/RAG/SQL, Large LLM (70B+) สำหรับ Complex Reasoning' },
    ],
  ...
  en: {
    ...
    cap4Title: 'Model Provider Routing',
    cap4Desc: 'Dynamic model orchestrator preventing vendor lock-in with seamless switching between On-Premise GPUs and Cloud AI providers.',
    cap4Items: [
      'Local Compute Plane: 100% private on-premise execution via Ollama, vLLM, and NVIDIA NIM.',
      'Cloud AI Adapters: Hybrid overflow to OpenAI, Anthropic Claude, and Google Gemini.',
      'Dynamic Model Sizing: Routes lightweight tasks to Small LLMs and heavy reasoning to Large LLMs.',
      'Provider Agnostic: Upgrade GPUs or swap model architectures without breaking UI clients.',
    ],
  ...
  zh: {
    ...
    cap4Title: '模型提供商智能路由 (Model Provider Routing)',
    cap4Desc: '智能模型路由系统，避免单一供应商绑定，支持本地私有 GPU 与云端 AI 无缝切换。',
    cap4Items: [
      '本地计算平面：通过 Ollama / vLLM / NVIDIA NIM 在私有 GPU 上 100% 本地运算。',
      '云端 AI 适配器：支持按需平滑分流至 OpenAI、Claude 和 Google Gemini。',
      '动态模型分级：简单任务路由至轻量 Small LLM，复杂推理路由至 Large LLM。',
      '无缝升级扩展：更换模型或扩展显卡无需修改前端任何代码。',
    ],
    ...
    hwRecs: [
      ...
      { title: '🔀 28. 大中小模型路由搭配策略', desc: 'Small LLM (3B-8B) 负责意图分类与路由，Medium LLM (14B-32B) 负责日常 RAG/SQL，Large LLM 负责高管深度推理。' },
    ],
  ...
  ja: {
    ...
    cap4Title: 'Model Provider Routing',
    cap4Desc: 'ベンダーロックインを防ぎ、オンプレミス GPU とクラウド AI を柔軟に切り替えるインテリジェントルーターです。',
    cap4Items: [
      'ローカル実行：Ollama / vLLM / NVIDIA NIM により社内 GPU で 100% 完結。',
      'クラウド連携：必要に応じて OpenAI、Claude、Gemini へ安全にハイブリッド接続。',
      '動的モデルサイズ選定：軽量タスクは Small LLM、高度な推論は Large LLM へ自動振り分け。',
      '柔軟な拡張性：フロントエンドコードを変更することなくモデルや GPU をアップグレード可能。',
    ],
    ...
    hwRecs: [
      ...
      { title: '🔀 28. モデルルーティング戦略', desc: 'Small LLM（3B-8B）を分類・意図判定、Medium LLM（14B-32B）を日常業務、Large LLM を高度な意思決定に配置。' },
    ],
  ...
  my: {
    ...
    cap4Title: 'Model Provider Routing',
    cap4Desc: 'Vendor တစ်ခုတည်းအပေါ် မှီခိုမှုကို ကာကွယ်ပေးပြီး On-Premise GPU နှင့် Cloud AI တို့အကြား လွတ်လပ်စွာ ရွေးချယ်နိုင်သော စနစ်။',
    cap4Items: [
      'Local Compute Plane: ကုမ္ပဏီတွင်း GPU (Ollama / vLLM / NIM) ဖြင့် ဒေတာအပြင်မထွက်ဘဲ ၁၀၀% လုံခြုံစွာ အလုပ်လုပ်ခြင်း။',
      'Cloud AI Adapters: လိုအပ်ပါက OpenAI၊ Claude၊ Gemini တို့နှင့် လွယ်ကူစွာ ချိတ်ဆက်အသုံးပြုနိုင်ခြင်း။',
      'Dynamic Model Sizing: ရိုးရှင်းသော မေးခွန်းများကို Small LLM သို့၊ ရှုပ်ထွေးသော မေးခွန်းများကို Large LLM သို့ ပို့ဆောင်ခြင်း။',
      'Provider Agnostic: စနစ်ကို မပြင်ဆင်ဘဲ Model အသစ်များ သို့မဟုတ် GPU အသစ်များကို အချိန်မရွေး လဲလှယ်တိုးမြှင့်နိုင်ခြင်း။',
    ],
    ...
    hwRecs: [
      ...
      { title: '🔀 ၂၈။ Model Routing ဗျူဟာ', desc: 'Small LLM (3B-8B) ကို မေးခွန်းခွဲခြားရန်၊ Medium LLM (14B-32B) ကို အထွေထွေသုံးရန်၊ Large LLM ကို ခွဲခြမ်းစိတ်ဖြာမှုကြီးများအတွက် သုံးသည်။' },
    ],
