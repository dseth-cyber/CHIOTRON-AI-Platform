...
2. เมื่อพบหน้าต่าง **"เชื่อมต่อกับ AI Platform (Connect)"** ให้นำรหัสคีย์ที่สร้างจากคำสั่ง Bootstrap (`ceap_...`) มาวางในช่อง API Key
3. คลิก **"เชื่อมต่อ (Connect)"** ระบบจะตรวจสอบสิทธิ์และพาเข้าสู่หน้า Dashboard ทันที

### 2️⃣ การสนทนาและโต้ตอบด้วยเสียง (AI Chat & Voice Loop)
1. คลิกเมนู **"แชท / สนทนา" (Chat)**
2. พิมพ์ข้อความสอบถาม หรือคลิกไอคอน **🎙️ ไมโครโฟน** เพื่อคุยด้วยเสียงภาษาไทย/อังกฤษแบบ Real-time
3. เลือกโมเดลที่ต้องการใช้งานด้านบน (เช่น Fast Tier, RAG Assistant หรือ Reasoning Model)

### 3️⃣ การลากวางและวิเคราะห์เอกสาร (Document Analyze Workspace)
1. คลิกเมนู **"วิเคราะห์เอกสาร" (Analyze)**
2. ลากไฟล์เอกสารมาวางในกรอบ **Modern Glass Dropzone** (รองรับ `.xlsx`, `.xls`, `.csv`, `.pdf`, `.txt`, `.docx` และรูปภาพ)
3. ระบบจะแสดงตารางตัวอย่างข้อมูล (Interactive Data Preview) และสั่ง AI สรุป วิเคราะห์ตัวเลข หรือตอบคำถามจากไฟล์ได้ทันที

### 4️⃣ การจัดการคลังความรู้สำหรับองค์กร (Enterprise Knowledge RAG)
1. คลิกเมนู **"คลังความรู้" (Knowledge)**
2. อัปโหลดเอกสารระเบียบข้อบังคับหรือคู่มือองค์กรเข้าระบบ
3. ระบบ Go Control Plane จะทำการตัด Chunk และฝัง Vector Embeddings ลง PostgreSQL pgvector โดยอัตโนมัติ เพื่อให้ AI ใช้ค้นหาอ้างอิงคำตอบได้อย่างแม่นยำ

### 5️⃣ การสร้างกุญแจสำรองฉุกเฉิน (Break-Glass Key for ERP Outage)
1. คลิกเมนู **"การตั้งค่า" (Settings)**
2. เลื่อนลงมาที่หัวข้อ **`🔑 กุญแจฉุกเฉินและ API Keys (Break-Glass & Local Auth Fallback)`**
3. คลิก **`🚨＋ สร้างกุญแจฉุกเฉิน (Break-Glass Key)`** แล้วคัดลอกกุญแจสำรองเก็บไว้ในตู้เซฟรหัสผ่านของฝ่าย IT เพื่อใช้เข้าใช้งานได้ทันทีแม้ระบบ ERP หรือ SSO ภายนอกจะดับหรือขัดข้อง
